...
namespace AceLand.Injection
{
    ...
    {
        public static void InjectGameObject(this IResolver resolver, GameObject go)
        {
            if (!go) return;
            foreach (var mb in go.GetComponentsInChildren<MonoBehaviour>(true))
                if (mb) resolver.Inject(mb);
        }

        public static T Instantiate<T>(this IResolver r, T prefab, Transform parent = null,
                                       bool worldPositionStays = false) where T : Object
            => InstantiationStage.Instantiate(r, prefab, parent, worldPositionStays);

        public static T Instantiate<T>(this IResolver r, T prefab, Vector3 position,
        ...
        public static GameObject Instantiate(this IResolver r, GameObject prefab, Vector3 position,
