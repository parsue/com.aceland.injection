...
namespace AceLand.Injection
{
    ...
    public static class DI
    {
        ...
        public static Task StartupTask => _runner ? _runner.StartupTask : Task.CompletedTask;
        ...
        public static IResolver CreateScope(Action<IContainerBuilder> configure = null)
        ...
        public static IResolver CreateValidationContainer() => CreateGlobalBuilder(true).Build();
