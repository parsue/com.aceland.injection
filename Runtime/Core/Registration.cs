...
namespace AceLand.Injection
{
    public sealed class Registration
    {
        ...
        public Action<IResolver, object> OnActivated;
    ...
    {
        public string Name; public Type Type; public Func<IResolver, object> Value;
    }
    public sealed class MemberOverride
    {
        public string Name; public Func<IResolver, object> Value; public bool Optional;
    }
