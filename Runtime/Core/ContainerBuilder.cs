...
namespace AceLand.Injection
{
    public sealed class ContainerBuilder : IContainerBuilder
    {
        ...
        internal readonly List<Action<IResolver>> BuildCallbacks = new();
        ...
        public ContainerBuilder(IResolver parent) => ParentContainer = parent as Container;
        ...
        public IRegistrationBuilder RegisterFactory(Type contractType, Func<IResolver, object> factory,
                                                    Lifetime lifetime)
        {
            var reg = new Registration
            {
        ...
        public void AddEntryPoint(Type type) => EntryPointTypes.Add(type);
        public void RegisterBuildCallback(Action<IResolver> cb) => BuildCallbacks.Add(cb);
        ...
        public IResolver Build() => new Container(this, ParentContainer);
    }
}