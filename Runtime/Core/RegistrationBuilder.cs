...
namespace AceLand.Injection
{
    internal sealed class RegistrationBuilder : IRegistrationBuilder
    {
        ...
        public IRegistrationBuilder WithParameter(string name, Func<IResolver, object> f)
        ...
        public IRegistrationBuilder WithParameter(Type t, Func<IResolver, object> f)
        ...
        public IRegistrationBuilder InjectMember(string name, Func<IResolver, object> f, bool optional = false)
        {
        ...
        public IRegistrationBuilder OnActivated(Action<IResolver, object> cb) { _r.OnActivated += cb; return this; }
