...
{
    public sealed class Container : IResolver, IAsyncDisposable, IContainerIntrospection
    {
        ...
        internal Container(ContainerBuilder builder, Container parent)
        {
            ...
            self.ContractTypes.Add(typeof(IResolver));
        ...
        public IResolver CreateScope(Action<IContainerBuilder> configure = null)
        {
            ThrowIfDisposed();
    ...
    IResolver IContainerIntrospection.ParentResolver => _parent;
