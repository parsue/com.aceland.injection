...
namespace AceLand.Injection.SourceGenerator
{
    internal sealed class Symbols
    {
        ...
        public readonly INamedTypeSymbol GlobalInstaller, AutoInstall, InjectionInstaller;
        ...
        public Symbols(Compilation c, INamedTypeSymbol inject)
        {
            ...
            GlobalInstaller = c.GetTypeByMetadataName("AceLand.Injection.IGlobalInstaller");
            AutoInstall = c.GetTypeByMetadataName("AceLand.Injection.AutoInstallAttribute");
            InjectionInstaller = c.GetTypeByMetadataName("AceLand.Injection.InjectionInstallerAttribute");
    ...
    internal sealed class InstallerModel
    {
        public string TypeFullName;
        public int Order;
    }
